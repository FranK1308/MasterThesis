...
structures = read("/home/frank/multif/egnn/data/reduced_unique_no_outliers.extxyz", index=':10')
print('Loaded structure data')

# Define the cutoff distance for neighbors
cutoff = 7.0  # Adjust this value based on your specific needs

# Initialize the dataset with the list of Atoms objects and cutoff distance
dataset = Convert(atoms=structures, cutoff=cutoff)
